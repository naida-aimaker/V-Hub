...
* `v_hub` - project identifier (lowercase, no spaces, i.e. "snake_case") used for bundle IDs and package names.
* `` - project description.
* `V-Hub` - executable or bundle name on disk.
* `V-Hub` - display name shown in window titles and about app dialogs.
